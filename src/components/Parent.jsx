    ...
    <div>
      ...
      {(userData[0] && userId && userData[0].user_category === "parent") ?
        <div style={{display:'flex'}}>
          ...
          <div class="box" style={{width: "20%",height: "500px",marginTop: "100px",marginLeft:"0px",marginRight: "200px"}}>
            ...
            <p>Βασικά Στοιχεία</p>
            <br />
            <h3>Όνομα: {userData[0].name || 'Άγνωστο'}</h3>
            <h3>Επώνυμο: {userData[0].surname || 'Άγνωστο'}</h3>
            <h3>ΑΦΜ: {userData[0].AFM || 'Άγνωστο'}</h3>
            <h3>Τόπος Κατοικίας: {userData[0].home || 'Άγνωστο'}</h3>
            <h3>Τηλέφωνο: {userData[0].phone || 'Άγνωστο'}</h3>
            <h3>Email: {userData[0].email || 'Άγνωστο'}</h3>
            <div style={{display:'flex', justifyContent:'center'}}>
