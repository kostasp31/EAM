...
const Parent = () => {
  ...
  return (
    <div>
      ...
      <h1 style={{ marginTop: "35px", marginLeft: "300px"}}>&emsp;Αρχική σελίδα</h1>

      {(userData[0] && userId && userData[0].user_category === "parent") ?
        <div style={{display:'flex'}}>
          <div class="box" style={{width: "30%",height: "900px",marginTop: "100px",marginLeft:"600px",marginRight: "100px", marginBottom:"50px"}}>
            <h2 style={{textAlign:'center'}}>Επισκόπιση ενεργειών</h2>
            <p style={{textAlign:'center'}}>Οι ενέργειές σας στην πλατφόρμα</p>
            <br />
            <h3>Έχετε υποβάλλει οριστικά 1 <a href='/applications' style={{color:'blue'}}>αίτηση</a> (0 <a href='/applications' style={{color:'blue'}}>προσωρινά αποθηκευμένες</a>).</h3>
            <div style={{display:'flex', justifyContent:'center'}}>
              <a className='button-purple' href='/applications'><b style={{color:'#65558f'}}>Προβολή Αιτήσεων</b></a>
              <a className='button-purple'><b style={{color:'red'}}>Δημιουργία Νέας</b></a>   {/* TODO LINK TO NEW APPLICATION PAGE*/}
            </div>
            <hr />
          ...
          <div class="box" style={{width: "20%",height: "600px",marginTop: "100px",marginLeft:"0px",marginRight: "200px"}}>
            ...
            <div style={{display:'flex', gap:'50px', textAlign:'left'}}>
              <h3 style={{flex:'1'}}>Όνομα: </h3>
              <h3 style={{ flex:'1'}}>{userData[0].name || 'Άγνωστο'}</h3>
            </div>
            <div style={{display:'flex', gap:'50px', textAlign:'left'}}>
              <h3 style={{flex:'1'}}>Επώνυμο: </h3>
              <h3 style={{ flex:'1'}}>{userData[0].surname || 'Άγνωστο'}</h3>
            </div>
            <div style={{display:'flex', gap:'50px', textAlign:'left'}}>
              <h3 style={{flex:'1'}}>ΑΦΜ: </h3>
              <h3 style={{ flex:'1'}}>{userData[0].AFM || 'Άγνωστο'}</h3>
            </div>
            <div style={{display:'flex', gap:'50px', textAlign:'left'}}>
              <h3 style={{flex:'1'}}>Τόπος Κατοικίας: </h3>
              <h3 style={{ flex:'1'}}>{userData[0].home || 'Άγνωστο'}</h3>
            </div>
            <div style={{display:'flex', gap:'50px', textAlign:'left'}}>
              <h3 style={{flex:'1'}}>Τηλέφωνο: </h3>
              <h3 style={{ flex:'1'}}>{userData[0].phone || 'Άγνωστο'}</h3>
            </div>
            <div style={{display:'flex', gap:'50px', textAlign:'left'}}>
              <h3 style={{flex:'1', marginBottom:'30px'}}>Email: </h3>
              <h3 style={{ flex:'1'}}>{userData[0].email || 'Άγνωστο'}</h3>
            </div>
            <div style={{display:'flex', justifyContent:'center'}}>
              <a className='button-purple' href='/profile'><b>Προβολή Προφίλ</b></a>
              <a className='button-purple' style={{color:'red'}}><b>Επεξεργασία</b></a>
            </div>
          </div>
        </div>
        :
