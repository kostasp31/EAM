...
const DisplayPro = ({ data, minRating, availability, selectedDate, setSelectedDate }) => {
  ...
  return (
    <div className='box' style={{ display: 'flex', height: "150px", padding: '20px', marginTop: "50px", marginLeft: "20px", marginRight: "150px", marginBottom: "50px" }}>
      {/* <CircleWithInitialsRev name={data.name} surname={data.surneme}/> */}
  ...
  return (
    <div>
      ...
      {(userData[0] && userId && userData[0].user_category === "parent") ?
        <div style={{ display: 'flex' }}>
          <div className='box' style={{ width: "300px", height: "1070px", marginTop: "50px", marginLeft: "300px", marginRight: "100px", marginBottom: "50px" }}>
          ...
          <div style={{ display: 'block', width: "60%" }}>
            ...
            {/* <div style={{
              ...
              <button style={{
                backgroundColor: page===1 ? '#c4c4c4' : '#007bff',
                color: '#fff',
                border: 'none',
                borderRadius: '5px',
                padding: '8px 12px',
              ...
              <button style={{
                ...
                onClick={() => {page < proData.length/5  ? setPage(page+1) : ''}}
              >
                {'>'}
              </button>
            </div> */}
