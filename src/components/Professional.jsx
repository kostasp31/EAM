            ...
            <div className="box top-left">
              ...
              {!userData[0].notifications || userData[0].notifications.length === 0 ?
                ...
                userData[0].notifications.length === 1 ?
                  <h3>Έχετε 1 <a href='/colabs_profs' style={{ color: 'blue' }}>ειδοποίηση</a>.</h3>
                  :
                  <h3>Έχετε {userData[0].notifications.length} <a href='/notifs_profs' style={{ color: 'blue' }}>ειδοποιήσεις</a>.</h3>
              }
              <a className='button-purple-center' href='/notifs_profs' style={{ width: '190px' }}><b style={{ color: '#65558f' }}>Προβολή Ειδοποιήσεων</b></a>
              <hr />
              ...
              {!userData[0].dates || userData[0].dates.filter((el) => el.state === 'pending').length === 0 ?
                ...
                userData[0].dates.filter((el) => el.state === 'pending').length === 1 ?
                  <h3>Εκκρεμεί 1 <a href='/dates_profs' style={{ color: 'blue' }}>ραντεβού με γονέα</a>.</h3>
                  :
